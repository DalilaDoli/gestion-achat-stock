                                        ...
                                        <td class="project-actions text-left">
                                            ...
                                            @else
                                                '{{ $cmd->dmachat->code }}' @endif,{{ $cmd->dt_commandes }})"><i
                                                    class="fa fa-eye"></i></a>
                                            <a class="modal-effect btn btn-sm btn-warning" href="{{route('printcmd',$cmd->id)}}" target="_blank">
                                                <i class="fas fa-print" data-toggle="tooltip" title="Imprimer">
                                                </i></a></a>
                                                <a class="modal-effect btn btn-sm btn-danger"
                                                data-effect="effect-scale" data-id="{{ $cmd->id }}"
                                                data-toggle="modal"
                                                href="#modasupp" title="Delete">
                                                    <i class="fas fa-trash" data-toggle="tooltip" title="Supprimer">
                                                    </i></a>

                                                    <form action="{{ route('AnnulationCmd') }}" method="post">
                                                        @csrf
                                                        @method('')
                                                        <!-- Delete Modal HTML -->
            ...
            <form method="post" action="" autocomplete="off" class="form-horizontal" id="formUp">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="fournisseur_id" id="fournisseurcmd" class="form-control custom-select" required>
...
<script>
    ...
    <script>
        ...
        $('#modalda').on('hidden.bs.modal', function () {
        clearModalInputs('modalda');
        });
    </script>
