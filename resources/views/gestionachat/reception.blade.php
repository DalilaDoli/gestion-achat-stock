            ...
            <div class="col-6">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Liste Receptions</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions text-left">
                                            <button type="button" class="btn btn-success btn-sm"
                                                onclick="recupcmd({{ $reception->id }},'{{ $reception->code }}','{{ date('Y-m-d H:i', strtotime($reception->date)) }}','{{ $reception->fournisseur->id }}', '{{ $reception->commande_id }}',@if ($reception->statuts->sortBy('created_at')->last() == null) '{{ null }}'
                                            @else
                                                '{{ $reception->statuts->first()->typestatut->libelle }}' @endif,'{{ $reception->commande->code }}' ,{{ $reception->dt_receptions }})">
                                                <i class="fas fa-pencil-alt"></i>
                                            </button>
                                            <a class="modal-effect btn btn-sm btn-info" href="#hh" title="Edit"
                                                onclick="consultcmd({{ $reception->id }},'{{ $reception->code }}','{{ date('Y-m-d H:i', strtotime($reception->date)) }}','{{ $reception->fournisseur->id }}','{{ $reception->commande_id }}', @if ($reception->statuts->sortBy('created_at')->last() == null) '{{ null }}'
                                            @else
                                                '{{ $reception->statuts->first()->typestatut->libelle }}' @endif,'{{ $reception->commande->code }}' ,{{ $reception->dt_receptions}})"><i
                                                    class="fa fa-eye"></i></a>
                                            <a class="modal-effect btn btn-sm btn-warning" href="" target="_blank">
                                                ...
                                                data-effect="effect-scale" data-id="{{ $reception->id }}"
                                                data-toggle="modal"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Etes vous sur de vouloir supprimer la commande</p>
            ...
            <form method="post" action="" autocomplete="off" class="form-horizontal" id="formUp">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="code" id="codecmd" value="" disabled>
